...
class ICNN(nn.Module):
    ...
    def convex_training(self, input_data, target_data, epochs=25000, epsilon=30, learning_rate=0.01):
        """
        ...
        scheduler = lr_scheduler.ReduceLROnPlateau(optimizer, mode='min', factor=0.8, patience=1000)
